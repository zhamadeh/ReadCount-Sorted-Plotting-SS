...
#pdf()
breakpointr(inputfolder="/home/zhamadeh/ALL_BAM_FILES/", outputfolder="/home/zhamadeh/StrandSeeker/BPR_output", pairedEndReads=TRUE, numCPU=6,windowsize=175,binMethod="reads",peakTh=0.3875,min.mapq=7.75,trim=6.5,background=0.15)
